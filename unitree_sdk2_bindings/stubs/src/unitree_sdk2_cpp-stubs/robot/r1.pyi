...
class JsonizeDataVecFloat(object):
    def __init__(self) -> None:
        """SIGNATURE_ONLY; C++: unitree::robot::r1::JsonizeDataVecFloat::JsonizeDataVecFloat()."""
        ...
    data: list[float]
...
class JsonizeVelocityCommand(object):
    def __init__(self) -> None:
        """SIGNATURE_ONLY; C++: unitree::robot::r1::JsonizeVelocityCommand::JsonizeVelocityCommand()."""
        ...
    velocity: list[float]
    duration: float
    def from_json(self, json: dict[str, Any]) -> None:
...
class LedControlParameter(object):
    def __init__(self) -> None:
        """SIGNATURE_ONLY; C++: unitree::robot::r1::LedControlParameter::LedControlParameter()."""
        ...
    r: int
    g: int
    b: int
...
class PlayStopParameter(object):
    def __init__(self) -> None:
        """SIGNATURE_ONLY; C++: unitree::robot::r1::PlayStopParameter::PlayStopParameter()."""
        ...
    app_name: str
    def from_json(self, json: dict[str, Any]) -> None:
        """SIGNATURE_ONLY | UNCLASSIFIED | SIGNATURE_PREVIEW. C++: fromJson(common::JsonMap &)."""
...
class PlayStreamParameter(object):
    def __init__(self) -> None:
        """SIGNATURE_ONLY; C++: unitree::robot::r1::PlayStreamParameter::PlayStreamParameter()."""
        ...
    app_name: str
    stream_id: str
    def from_json(self, json: dict[str, Any]) -> None:
...
class TtsMakerParameter(object):
    def __init__(self) -> None:
        """SIGNATURE_ONLY; C++: unitree::robot::r1::TtsMakerParameter::TtsMakerParameter()."""
        ...
    index: int
    speaker_id: int
    text: str
