...
class FsmIdInfo(object):
    ...
    def __init__(self) -> None:
        """SIGNATURE_ONLY; C++: unitree::robot::h2::FsmIdInfo::FsmIdInfo()."""
        ...
    @overload
    def __init__(self, i: int, n: str) -> None:
        """SIGNATURE_ONLY; C++: unitree::robot::h2::FsmIdInfo::FsmIdInfo(int, const std::string &)."""
        ...
    id: int
    name: str
...
class JsonizeDataVecFloat(object):
    def __init__(self) -> None:
        """SIGNATURE_ONLY; C++: unitree::robot::h2::JsonizeDataVecFloat::JsonizeDataVecFloat()."""
        ...
    data: list[float]
    def from_json(self, json: dict[str, Any]) -> None:
        """SIGNATURE_ONLY | UNCLASSIFIED | SIGNATURE_PREVIEW. C++: fromJson(common::JsonMap &)."""
...
class JsonizeFsmIdList(object):
    def __init__(self) -> None:
        """SIGNATURE_ONLY; C++: unitree::robot::h2::JsonizeFsmIdList::JsonizeFsmIdList()."""
        ...
...
class JsonizeVelocityCommand(object):
    def __init__(self) -> None:
        """SIGNATURE_ONLY; C++: unitree::robot::h2::JsonizeVelocityCommand::JsonizeVelocityCommand()."""
        ...
    velocity: list[float]
    duration: float
    def from_json(self, json: dict[str, Any]) -> None:
...
class LocoClient(Client):
    ...
    def set_punch_api(self) -> tuple[int, list[float]]:
        """SIGNATURE_ONLY | MOTION_COMMAND | OUTPUT_WRAPPER. C++: SetPunchApi(std::vector<float> &)."""
        ...
    ...
    def set_arm_sdk_status(self, arm_sdk_status: bool) -> int:
        """SIGNATURE_ONLY | MOTION_COMMAND | DIRECT. C++: SetArmSdkStatus(bool)."""
        ...
    def damp(self) -> int:
    ...
    def enable_arm_sdk(self) -> int:
        """SIGNATURE_ONLY | MOTION_COMMAND | DIRECT. C++: EnableArmSDK()."""
        ...
    def disable_arm_sdk(self) -> int:
        """SIGNATURE_ONLY | MOTION_COMMAND | DIRECT. C++: DisableArmSDK()."""
        ...
