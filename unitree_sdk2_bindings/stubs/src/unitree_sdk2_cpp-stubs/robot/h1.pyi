...
class JsonizeDataVecFloat(object):
    def __init__(self) -> None:
        """SIGNATURE_ONLY; C++: unitree::robot::h1::JsonizeDataVecFloat::JsonizeDataVecFloat()."""
        ...
    data: list[float]
...
class JsonizeTargetPos(object):
    def __init__(self) -> None:
        """SIGNATURE_ONLY; C++: unitree::robot::h1::JsonizeTargetPos::JsonizeTargetPos()."""
        ...
    x: float
    y: float
    yaw: float
...
class JsonizeVelocityCommand(object):
    def __init__(self) -> None:
        """SIGNATURE_ONLY; C++: unitree::robot::h1::JsonizeVelocityCommand::JsonizeVelocityCommand()."""
        ...
    velocity: list[float]
    duration: float
    def from_json(self, json: dict[str, Any]) -> None:
...
class LocoClient(Client):
    ...
    def enable_odom(self) -> int:
        """SIGNATURE_ONLY | MOTION_COMMAND | DIRECT. C++: EnableOdom()."""
        ...
    def disable_odom(self) -> int:
        """SIGNATURE_ONLY | MOTION_COMMAND | DIRECT. C++: DisableOdom()."""
        ...
    ...
    def set_phase(self, phase: Sequence[float]) -> int:
        """SIGNATURE_ONLY | MOTION_COMMAND | DIRECT. C++: SetPhase(std::vector<float>)."""
        ...
    def set_target_pos(self, x: float, y: float, yaw: float, relative: bool = ...) -> int:
        """SIGNATURE_ONLY | MOTION_COMMAND | DIRECT. C++: SetTargetPos(float, float, float, bool)."""
        ...
    ...
    def set_next_foot(self, foot: bool) -> int:
        """SIGNATURE_ONLY | MOTION_COMMAND | DIRECT. C++: SetNextFoot(bool)."""
        ...
    def wave_hand(self) -> int:
        """SIGNATURE_ONLY | MOTION_COMMAND | DIRECT. C++: WaveHand()."""
        ...
