...
class ConfigClient(Client):
    ...
    def meta_config_meta(self, name: str) -> tuple[int, ConfigMeta]:
        """SIGNATURE_ONLY | HARDWARE_SIDE_EFFECT | OUTPUT_WRAPPER. C++: Meta(const std::string &, unitree::robot::b2::ConfigMeta &)."""
        ...
    ...
    def subscribe_change_status(self, name: str, callback: Callable[[str, str], None]) -> None:
        """SIGNATURE_ONLY | HARDWARE_SIDE_EFFECT | CALLBACK_MANUAL. C++: SubscribeChangeStatus(const std::string &, const unitree::robot::b2::ConfigChangeStatusCallback &)."""
        ...

class ConfigDelParameter(object):
    def __init__(self) -> None:
        """SIGNATURE_ONLY; C++: unitree::robot::b2::ConfigDelParameter::ConfigDelParameter()."""
        ...
    name: str
...
class ConfigGetData(object):
    def __init__(self) -> None:
        """SIGNATURE_ONLY; C++: unitree::robot::b2::ConfigGetData::ConfigGetData()."""
        ...
    content: str
    def from_json(self, json: dict[str, Any]) -> None:
        """SIGNATURE_ONLY | UNCLASSIFIED | SIGNATURE_PREVIEW. C++: fromJson(common::JsonMap &)."""
...
class ConfigGetParameter(object):
    def __init__(self) -> None:
        """SIGNATURE_ONLY; C++: unitree::robot::b2::ConfigGetParameter::ConfigGetParameter()."""
        ...
    name: str
    def from_json(self, json: dict[str, Any]) -> None:
        """SIGNATURE_ONLY | UNCLASSIFIED | SIGNATURE_PREVIEW. C++: fromJson(common::JsonMap &)."""
...
class ConfigMeta(object):
    def __init__(self) -> None:
        """SIGNATURE_ONLY; C++: unitree::robot::b2::ConfigMeta::ConfigMeta()."""
        ...
    name: str
    last_modified: str
    size: int
...
class ConfigMetaData(object):
    def __init__(self) -> None:
        """SIGNATURE_ONLY; C++: unitree::robot::b2::ConfigMetaData::ConfigMetaData()."""
        ...
...
class ConfigMetaParameter(object):
    def __init__(self) -> None:
        """SIGNATURE_ONLY; C++: unitree::robot::b2::ConfigMetaParameter::ConfigMetaParameter()."""
        ...
    name: str
    def from_json(self, json: dict[str, Any]) -> None:
        """SIGNATURE_ONLY | UNCLASSIFIED | SIGNATURE_PREVIEW. C++: fromJson(common::JsonMap &)."""
...
class ConfigSetParameter(object):
    def __init__(self) -> None:
        """SIGNATURE_ONLY; C++: unitree::robot::b2::ConfigSetParameter::ConfigSetParameter()."""
        ...
    name: str
    content: str
    def from_json(self, json: dict[str, Any]) -> None:
...
class JsonizeConfigMeta(object):
    def __init__(self) -> None:
        """SIGNATURE_ONLY; C++: unitree::robot::b2::JsonizeConfigMeta::JsonizeConfigMeta()."""
        ...
    name: str
    last_modified: str
    size: int
...
class JsonizeModeName(object):
    def __init__(self) -> None:
        """SIGNATURE_ONLY; C++: unitree::robot::b2::JsonizeModeName::JsonizeModeName()."""
        ...
    name: str
    form: str
    def from_json(self, json: dict[str, Any]) -> None:
...
class JsonizeSilent(object):
    def __init__(self) -> None:
        """SIGNATURE_ONLY; C++: unitree::robot::b2::JsonizeSilent::JsonizeSilent()."""
        ...
    silent: bool
    def from_json(self, json: dict[str, Any]) -> None:
        """SIGNATURE_ONLY | UNCLASSIFIED | SIGNATURE_PREVIEW. C++: fromJson(common::JsonMap &)."""
...
class LowPowerStatusData(object):
    def __init__(self) -> None:
        """SIGNATURE_ONLY; C++: unitree::robot::b2::LowPowerStatusData::LowPowerStatusData()."""
        ...
    status: int
    def from_json(self, json: dict[str, Any]) -> None:
        """SIGNATURE_ONLY | UNCLASSIFIED | SIGNATURE_PREVIEW. C++: fromJson(common::JsonMap &)."""
...
class LowPowerSwitchParameter(object):
    def __init__(self) -> None:
        """SIGNATURE_ONLY; C++: unitree::robot::b2::LowPowerSwitchParameter::LowPowerSwitchParameter()."""
        ...
    swit: int
    def from_json(self, json: dict[str, Any]) -> None:
        """SIGNATURE_ONLY | UNCLASSIFIED | SIGNATURE_PREVIEW. C++: fromJson(common::JsonMap &)."""
...
class MotionSwitcherClient(Client):
    ...
    def select_mode(self, name_or_alias: str) -> int:
        """SIGNATURE_ONLY | MOTION_COMMAND | DIRECT. C++: SelectMode(const std::string &)."""
        ...
    def release_mode(self) -> int:
        """SIGNATURE_ONLY | MOTION_COMMAND | DIRECT. C++: ReleaseMode()."""
        ...
    def set_silent(self, silent: bool) -> int:
        """SIGNATURE_ONLY | MOTION_COMMAND | DIRECT. C++: SetSilent(bool)."""
        ...
...
class PkgVersionData(object):
    def __init__(self) -> None:
        """SIGNATURE_ONLY; C++: unitree::robot::b2::PkgVersionData::PkgVersionData()."""
        ...
    package_version: str
...
class RobotStateClient(Client):
    ...
    def low_power_switch(self, swit: int) -> int:
        """SIGNATURE_ONLY | HARDWARE_SIDE_EFFECT | DIRECT. C++: LowPowerSwitch(int32_t)."""
        ...
    def low_power_status(self) -> tuple[int, int]:
        """SIGNATURE_ONLY | HARDWARE_SIDE_EFFECT | OUTPUT_WRAPPER. C++: LowPowerStatus(int32_t &)."""
        ...
...
class ServiceStateData(object):
    def __init__(self) -> None:
        """SIGNATURE_ONLY; C++: unitree::robot::b2::ServiceStateData::ServiceStateData()."""
        ...
    name: str
    status: int
    protect: int
...
class ServiceSwitchData(object):
    def __init__(self) -> None:
        """SIGNATURE_ONLY; C++: unitree::robot::b2::ServiceSwitchData::ServiceSwitchData()."""
        ...
    name: str
    status: int
    def from_json(self, json: dict[str, Any]) -> None:
...
class ServiceSwitchParameter(object):
    def __init__(self) -> None:
        """SIGNATURE_ONLY; C++: unitree::robot::b2::ServiceSwitchParameter::ServiceSwitchParameter()."""
        ...
    name: str
    swit: int
    def from_json(self, json: dict[str, Any]) -> None:
...
class SetReportFreqParameter(object):
    def __init__(self) -> None:
        """SIGNATURE_ONLY; C++: unitree::robot::b2::SetReportFreqParameter::SetReportFreqParameter()."""
        ...
    interval: int
    duration: int
    def from_json(self, json: dict[str, Any]) -> None:
...
class SportClient(Client):
    def __init__(self, enable_lease: bool = ...) -> None:
        """SIGNATURE_ONLY; C++: unitree::robot::b2::SportClient::SportClient(bool)."""
        ...
    def init(self) -> None:
    ...
    def trajectory_follow(self) -> tuple[int, list[Any]]:
        """SIGNATURE_ONLY | MOTION_COMMAND | OUTPUT_WRAPPER. C++: TrajectoryFollow(std::vector<unitree::robot::b2::PathPoint> &)."""
        ...
    ...
    def move_to_pos(self, x: float, y: float, yaw: float) -> int:
        """SIGNATURE_ONLY | MOTION_COMMAND | DIRECT. C++: MoveToPos(float, float, float)."""
        ...
    ...
    def vision_walk(self, flag: bool) -> int:
        """SIGNATURE_ONLY | MOTION_COMMAND | DIRECT. C++: VisionWalk(bool)."""
        ...
    ...
    def auto_recovery_set(self, flag: bool) -> int:
        """SIGNATURE_ONLY | MOTION_COMMAND | DIRECT. C++: AutoRecoverySet(bool)."""
        ...
    ...
    def fast_walk(self, flag: bool) -> int:
        """SIGNATURE_ONLY | MOTION_COMMAND | DIRECT. C++: FastWalk(bool)."""
        ...
    ...
    def free_height(self, flag: bool) -> int:
        """SIGNATURE_ONLY | MOTION_COMMAND | DIRECT. C++: FreeHeight(bool)."""
        ...
    def gait_height(self, flag: bool) -> int:
        """SIGNATURE_ONLY | MOTION_COMMAND | DIRECT. C++: GaitHeight(bool)."""
        ...
